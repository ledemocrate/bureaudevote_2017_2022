---
title: "De la recherche d'information sur les votes : une récupération de données"
author: "Katherine Hoffman"
date: 2020-04-10T21:13:14-05:00
categories: ["statistics","R","democratie","graphe","network","vote","inter-vote","depute"]
math: true
draft: false
...
> Une simple traduction de l'article d'explication du TMLE de Katherine Hoffman [TMLE tutorial](www.khstats.com/blog/tmle/tutorial) blog post.

### Un modèle conceptuel de données

![](/home/gollentw/Documents/ScriptR/projetDemocratie/data/img/umlScriptgetDataFinal.svg)){width=80%}

**La rechercehe des données de vote:**
  
On récupère le fichier source que l'on peut trouver au lien suivant https://data.assemblee-nationale.fr/travaux-parlementaires/votes.  

On ne trouve que très peu d'informations sur le jeu de données autre que le métadonné représenté dans le tableau ci dessous :
x1 <- c("éditeur","description","langue","format",type","titre","uri","date") 	Assemblée nationale
<- description 	Les scrutins AN (réalisés sur la machine de vote) pour la XV législature
langue 	fr
format 	application/zip
type 	Scrutins
titre 	Scrutins
uri 	http://data.assemblee-nationale.fr/static/openData/repository/15/loi/scrutins/Scrutins_XV.xml.zip
date 	2021-04-13 18:21:28.231451
identificateur 	Scrutins_XV.xml.zip
créateur 	Assemblée nationale
sujet 	scrutin 
...
*A visual guide designed as a printable reference is available on my [Github](https://github.com/hoffmakl/CI-visual-guides/blob/master/visual-guides/TMLE.pdf):*

![](/img/TMLE.jpg)


![](/home/gollentw/Téléchargements/nomnoml.svg)